...
$(function() {
    ...
    function(t) {
        ...
        if (!$.isEmptyObject(t.datas.chat_goods)) {
            ...
            var s = '<div class="nctouch-chat-product"> <div class="goods-pic"><img src="' + a.pic + '" alt=""/></div><div class="goods-info"><div class="goods-name"><a href="' + WapSiteUrl + "/tmpl/product_detail.html?goods_id=" + a.goods_id + '" target="_blank">' + a.goods_name + '</div></a><div class="goods-price">￥' + a.goods_promotion_price + "</div><p><a href='javascript:;' class='send_goods_url'>发送链接</a></p></div> </div>";
