    ...
    <table class="table tb-type2">
      <tbody>
       ...
       <!-- //zmr>v95-->
        ...
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['store_array']['store_company_name'];?>" id="store_company_name" name="store_company_name" class="txt"></td>
          <td class="vatop tips"></td>
        </tr>
        ...
        <tr class="noborder">
          ...
          <span id="region" class="w400">
            ...
            <input type="hidden" value="<?php echo $output['store_array']['province_id'];?>" name="province_id" id="province_id" class="area_ids" />
            <input type="hidden" value="<?php echo $output['store_array']['area_info'];?>" name="area_info" id="area_info" class="area_names" />
            <?php if(!empty($output['store_array']['province_id'])){?>
