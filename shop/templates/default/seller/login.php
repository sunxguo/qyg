...
<div class="ncsc-login-container">
  ...
  <form id="form_login" action="index.php?act=seller_login&op=login" method="post" >
    ...
    <div class="input">
      ...
      <div class="code">
        <div class="arrow"></div>
        <div class="code-img"><a href="javascript:void(0)" nctype="btn_change_seccode"><img src="<?php echo SHOP_SITE_URL?>/control/seccodes.php" name="codeimage" border="0" id="codeimage"></a></div>
